...
import Wlog from "./images/w_log.png";
...
import {IoLogoFacebook, IoLogoInstagram, IoMdPhonePortrait} from "react-icons/io"

// addign the navbar Icons
...
function App() {
  ...
  return (
    <div style={{
      ...
      <div className='navbar_black_layer'></div>
      <div id='navbar_main'>
        <div id='navbar_wrapper'>
          <div className='navbar_cont'>
            ...
            ></FiInfo>
            <RiCustomerService2Line className='nav_cont'></RiCustomerService2Line>
          </div>
          <div id='navbar_i_wrapper'>
            <img id='navbar_i' src={Wlog}></img>
          </div>
          <div className='navbar_cont'>
            <SiMaterialdesignicons className='nav_cont'></SiMaterialdesignicons>
            <MdContacts className='nav_cont'></MdContacts>
          </div>
        </div>
      </div>
      <div id='main' style={{
